...
var Earth = ({
  ...
  return /* @__PURE__ */ jsxs("div", { style: { position: "relative", width, height }, children: [
    /* @__PURE__ */ jsx("canvas", { ref: canvasRef, width, height }),
...
import { geoPath as geoPath2, geoNaturalEarth1 } from "d3-geo";
...
var Map = ({
  ...
  const pathGenerator = geoPath2().projection(projection);
  return /* @__PURE__ */ jsxs2("div", { style: { position: "relative", width, height }, children: [
    /* @__PURE__ */ jsx2(
      "svg",
      {
        ...
        children: /* @__PURE__ */ jsx2("g", { ref: gRef, children: countries2.map((country, i) => {
    ...
    tooltip.visible && svgRef.current && /* @__PURE__ */ jsx2(
      "div",
      {
        style: {
          position: "absolute",
